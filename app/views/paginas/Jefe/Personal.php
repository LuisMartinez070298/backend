...
<body>
 <p style="text-align: center; font-size: 30px;"><b>Añadir Usuario</b></h3></p>
 <div class="container">
  <div class="card bg-success text-white">
   <div class="card-header bg-dark">
    ...
    <div class="form-row text-center">
     <div class="col-12">
      <label for="Instruccion" style="color: #969696"><h4><small>Llene los campos para crear al usuario</small></h4></label>
      <!--Poner el nombre del usuario-->
     </div>
    </div>
   </div>
    <form action= "<?php echo RUTA_URL;?>/Usuarios/agregarPer" method="POST">
<div class="card-body">
  ...
  <div class="form-group">
   ...
   <input type="text" class="form-control" id="Nombre" name="Nombre" value="<?php echo $datos['Nombre']; ?>"   aria-describedby="Nombre" required maxlength="50" required minlength="3" pattern="^[a-zA-ZÑñÁáÉéÍíÓóÚúÜü\s]+$" required>
    ...
    <input type="text" class="form-control" id="Userr" name="Userr" value="<?php echo $datos['Userr']; ?>"   aria-describedby="Usuario" required minlength="3" required maxlength="30" required>
